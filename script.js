...
const translations = {
    ...
    en: {
        ...
        'team.czarnecki.bio3': 'Co-creator of successful FMCG product brands in Poland and Europe: Galbani (Eastern and Central Europe); Sekret Mnicha, Tartare, Turek (Poland); Zhivinka (Russia and Ukraine), Zvenigora (Ukraine), Delisana (Poland and Europe), Łomża (Poland), Cleanic (Poland and Europe), Sonko (Poland).',
        'team.czarnecki.bio4': 'Graduate of University of Warsaw, European University (MBA) in Barcelona, postgraduate studies at London Business School, INSEAD, Wharton Business School, and doctoral studies at the Faculty of Management and Finance at Warsaw School of Economics (SGH).',
        'team.czarnecki.bio5': 'Privately enjoys tennis, golf, and alpine skiing.',
